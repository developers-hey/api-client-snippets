...
1. CERT_PATH: This key specifies the path to the mTLS certificate file in the APIClient project. `Spanish translation:` Esta clave especifica la ruta al archivo del certificado mTLS en el proyecto APIClient.
2. PRIVATE_KEY_PATH: This key specifies the path to the client private key file in the APIClient project. `Spanish translation:` Esta clave especifica la ruta al archivo de la clave privada del cliente en el proyecto APIClient. 
3. PUBLIC_KEY_PATH: This key specifies the path to the server public key file in the APIClient project. `Spanish translation:` Esta clave especifica la ruta al archivo de clave pública del servidor en el proyecto APIClient. 
...
# Client Module  `Spanish translation:` Módulo Client
...
```
Step 1: Creates an instance of the Client client, which will be used to make requests to a server. ` Spanish translation:` Paso 1: Crea una instancia del cliente Client, que se utilizará para realizar solicitudes a un servidor.
